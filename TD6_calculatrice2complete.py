...
bouton_sub = Button(fenetre, text="-", padx=39, pady=20, command=lambda: Bouton_Sub(e.get()))
bouton_mult = Button(fenetre, text="*", padx=39, pady=20, command=lambda: Bouton_Mult(e.get()))
bouton_div = Button(fenetre, text="/", padx=39, pady=20, command=lambda: Bouton_Div(e.get()))
...
bouton_sub.grid(row=5, column=1)
bouton_mult.grid(row=5, column=2)
bouton_div.grid(row=6, column=0)

bouton_egal.grid(row=6, column=1, columnspan=2)
